        ...
        <div className="container">
            ...
            >
                ...
                <div className="relative">
                    <h2 className="text-5xl md:text-6xl max-w-sm mx-auto tracking-tighter text-center font-medium">FREE,OpenMic for Everyone</h2>
                    <p className="text-center text-lg md:text-xl max-w-xs mx-auto text-white/70 px-4 mt-5 tracking-tight">Achieve live Audience experience,without any hesitations.</p>
